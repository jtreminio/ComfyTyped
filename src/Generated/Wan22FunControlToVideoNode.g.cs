...
/// <remarks>Category: model/conditioning/wan/fun control</remarks>
public sealed class Wan22FunControlToVideoNode : ComfyNode
{
    /// <summary>ComfyUI <c>class_type</c> for this node — use for static refs (switch cases, <c>g.CreateNode(...)</c>).</summary>
    public const string ClassType = "Wan22FunControlToVideo";
    ...
    public Wan22FunControlToVideoNode()
    {
    ...
    public Wan22FunControlToVideoNode With(
