...
public sealed class ConditioningMultiplyNode : ComfyNode
{
    /// <summary>ComfyUI <c>class_type</c> for this node — use for static refs (switch cases, <c>g.CreateNode(...)</c>).</summary>
    public const string ClassType = "ConditioningMultiply";
    ...
    public ConditioningMultiplyNode()
    {
    ...
    public ConditioningMultiplyNode With(
