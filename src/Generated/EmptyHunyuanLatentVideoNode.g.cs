...
/// <remarks>Category: model/latent/hunyuan video</remarks>
public sealed class EmptyHunyuanLatentVideoNode : ComfyNode
{
    /// <summary>ComfyUI <c>class_type</c> for this node — use for static refs (switch cases, <c>g.CreateNode(...)</c>).</summary>
    public const string ClassType = "EmptyHunyuanLatentVideo";
    ...
    public EmptyHunyuanLatentVideoNode()
    {
    ...
    public EmptyHunyuanLatentVideoNode With(
        IntArg? Width = null,
        IntArg? Height = null,
        IntArg? Length = null,
