...
/// <summary>Joint video+audio latent for MiniMax H3.</summary>
/// <remarks>Category: SwarmUI/video</remarks>
public sealed class SwarmEmptyMiniMaxH3LatentAVNode : ComfyNode
{
    /// <summary>ComfyUI <c>class_type</c> for this node — use for static refs (switch cases, <c>g.CreateNode(...)</c>).</summary>
    public const string ClassType = "SwarmEmptyMiniMaxH3LatentAV";
    ...
    public SwarmEmptyMiniMaxH3LatentAVNode()
    {
    ...
    public SwarmEmptyMiniMaxH3LatentAVNode With(
        IntArg? Width = null,
        IntArg? Height = null,
        IntArg? Length = null
    )
